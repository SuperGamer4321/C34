...
function setup() 
{
  ...
  blower.position(270,370);
  blower.size(120,120);
  blower.mouseClicked(function(){
    Matter.Body.applyForce(fruit,{ x : 0 , y : 0 },{ x : 0.01 , y : -0.05 })
  });
  ...
  star1 = createSprite(350,50);
  star1.addImage("star1",starImg);
  star1.scale = 0.02;

  star2 = createSprite(50,350);
  star2.addImage("star2",starImg);
  star2.scale = 0.02;

  displayStars = createSprite(50,50);
...
function draw() 
{
  ...
  if(collide(fruit,star1,20)===true && !isTouchedStar1){
    star1.visible = false ;
  ...
  if(collide(fruit,star2,20)===true && !isTouchedStar2){
    star2.visible = false ;
    isTouchedStar2 = true;
    starCount++;
  }
